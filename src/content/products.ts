...
export const products: Product[] = [
  ...
  // Chicken Broast & Roast
  {
    ...
    categoryIds: ["chicken"],
    images: [{ src: "https://images.unsplash.com/photo-1569058242253-11f8b4ed70d8?w=800&q=80&auto=format&fit=crop", alt: { en: "Chicken Broast" }, width: 800, height: 600, placeholder: true }],
  ...
  // Rolls & Shawarma
  {
    ...
    images: [{ src: "https://images.unsplash.com/photo-1626804475297-41609ea004bc?w=800&q=80&auto=format&fit=crop", alt: { en: "Spin Roll" }, width: 800, height: 600, placeholder: true }],
    basePrice: { amount: 500, currency: "PKR" },
    available: true,
    featured: false,
    sortOrder: 40,
  ...
  // Sides
  {
    ...
    categoryIds: ["sides"],
    images: [{ src: "https://images.unsplash.com/photo-1573081467611-82cd2e431f13?w=800&q=80&auto=format&fit=crop", alt: { en: "French Fries" }, width: 800, height: 600, placeholder: true }],
    basePrice: { amount: 250, currency: "PKR" },
    available: true,
    featured: false,
    sortOrder: 50,
  ...
  // Desserts
  {
    ...
    images: [{ src: "https://images.unsplash.com/photo-1589131649983-dbf074a1dc5c?w=800&q=80&auto=format&fit=crop", alt: { en: "Zarda" }, width: 800, height: 600, placeholder: true }],
  ...
  },
  {
    ...
    categoryIds: ["desserts"],
    images: [{ src: "https://images.unsplash.com/photo-1563805042-7684c8a9e9cb?w=800&q=80&auto=format&fit=crop", alt: { en: "Ice Cream" }, width: 800, height: 600, placeholder: true }],
